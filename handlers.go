...
func addSong(w http.ResponseWriter, r *http.Request) {
	...
	releaseDate, lyrics, link, err := fetchSongDetails(req.Group, req.Song)
	if err != nil {
...
func fetchSongDetails(group, song string) (releaseDate string, lyrics []string, link string, err error) {
